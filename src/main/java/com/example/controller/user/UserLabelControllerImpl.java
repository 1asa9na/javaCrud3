...
/**
 * Implementation of LabelController with user permission.
 */

public class UserLabelControllerImpl extends LabelController {

    public UserLabelControllerImpl(GenericView<Label> view, LabelService service) {
        super(view, service);
    }
