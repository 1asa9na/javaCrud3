...
--
-- Dumping data for table `post_labels`
--

LOCK TABLES `post_labels` WRITE;
/*!40000 ALTER TABLE `post_labels` DISABLE KEYS */;
/*!40000 ALTER TABLE `post_labels` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-08-24  3:44:00
